 ...
 */
function dot (key = _null, obj = {}, value = _null, _isfn = false) {
         let setter = ((_isfn = is(value, '!function')) ? (o, n) => { return n } : value),
             _value = (_isfn ? value : undefined);
         return key !== _null ? String(key).trim().split('.').reduce((a, b, idx, arr) => {
            return value !== _null ? a[b] = (idx !== arr.length-1 ? (a[b] ? a[b] : {}) : setter.apply(this, [a[b] || _null, _value])) : a[b];
         }, obj) : obj;
}
